...
[![Watch Demo Video](images/app/videoimage.jpg)](https://github.com/MenaFarhat/MEDIPHARMA-Dashboard/raw/main/Mockup-Video/demo.mp4)

## ⚙️ Getting Started

This project is built with Flutter and demonstrates admin dashboard functionality for healthcare management.
...
```bash
git clone https://github.com/MenaFarhat/MEDIPHARMA-Dashboard.git
cd MEDIPHARMA-Dashboard
flutter pub get
flutter run